-- ============================================================================
-- WSO2 PostgreSQL Database Initialization - Complete Setup
-- ============================================================================
-- This file consolidates all WSO2 database schemas for portability
-- Generated: $(date)
--
-- Databases created:
--   1. shared_db    - WSO2 shared registry and user management
--   2. apim_db      - WSO2 API Manager database
--   3. identity_db  - WSO2 Identity Server database
--   4. shared_db_is - WSO2 IS shared configuration
--
-- User: wso2carbon / wso2carbon
-- ============================================================================

-- Create databases for WSO2 API Manager and Identity Server (idempotent)
SELECT 'CREATE DATABASE apim_db' WHERE NOT EXISTS (SELECT FROM pg_database WHERE datname = 'apim_db')\gexec
SELECT 'CREATE DATABASE shared_db' WHERE NOT EXISTS (SELECT FROM pg_database WHERE datname = 'shared_db')\gexec
SELECT 'CREATE DATABASE shared_db_is' WHERE NOT EXISTS (SELECT FROM pg_database WHERE datname = 'shared_db_is')\gexec
SELECT 'CREATE DATABASE identity_db' WHERE NOT EXISTS (SELECT FROM pg_database WHERE datname = 'identity_db')\gexec

-- Create user for WSO2 (idempotent)
DO $$
BEGIN
  IF NOT EXISTS (SELECT FROM pg_catalog.pg_user WHERE usename = 'wso2carbon') THEN
...
-- ============================================================================
-- 02-shared-db-schema.sql
-- ============================================================================

-- Connect to shared_db database
\c shared_db
...
CREATE TABLE REG_RESOURCE_COMMENT (
            ID                      INTEGER DEFAULT NEXTVAL('REG_RESOURCE_COMMENT_PK_SEQ'),
...
CREATE TABLE REG_RESOURCE_RATING (
            ID                      INTEGER DEFAULT NEXTVAL('REG_RESOURCE_RATING_PK_SEQ'),
...
CREATE TABLE REG_RESOURCE_TAG (
            ID                      INTEGER DEFAULT NEXTVAL('REG_RESOURCE_TAG_PK_SEQ'),
...
CREATE TABLE REG_RESOURCE_PROPERTY (
            ID                      INTEGER DEFAULT NEXTVAL('REG_RESOURCE_PROPERTY_PK_SEQ'),
...
CREATE TABLE UM_SHARED_USER_ROLE(
    ID         INTEGER DEFAULT NEXTVAL('UM_SHARED_USER_ROLE_PK_SEQ'),
    UM_ROLE_ID INTEGER NOT NULL,
    UM_USER_ID INTEGER NOT NULL,
...
-- ============================================================================
-- 03-apim-db-schema.sql
-- ============================================================================

-- Connect to apim_db database
\c apim_db
...
CREATE TABLE IF NOT EXISTS IDN_OAUTH2_ACCESS_TOKEN_AUDIT (
            ID INTEGER DEFAULT NEXTVAL('IDN_OAUTH2_ACCESS_TOKEN_AUDIT_PK_SEQ'),
            TOKEN_ID VARCHAR (255),
            ACCESS_TOKEN VARCHAR(2048),
            REFRESH_TOKEN VARCHAR(2048),
            CONSUMER_KEY_ID INTEGER,
...
CREATE TABLE IF NOT EXISTS IDN_OAUTH2_SCOPE_BINDING (
            ID INTEGER DEFAULT NEXTVAL('IDN_OAUTH2_SCOPE_BINDING_PK_SEQ'),
...
CREATE TABLE IF NOT EXISTS IDN_OAUTH2_CIBA_REQUEST_SCOPES (
    ID INTEGER DEFAULT NEXTVAL('IDN_OAUTH2_CIBA_REQUEST_SCOPES_PK_SEQ'),
    AUTH_CODE_KEY CHAR (36),
    SCOPE VARCHAR (255),
...
DROP TABLE IF EXISTS AM_KEY_MANAGER_ALLOWED_ORGS;
...
DROP TABLE IF EXISTS AM_ORGANIZATION_MAPPING;
CREATE TABLE IF NOT EXISTS AM_ORGANIZATION_MAPPING (
...
CREATE TABLE AM_GATEWAY_PERMISSIONS (
  GATEWAY_UUID VARCHAR(45) NOT NULL,
  PERMISSIONS_TYPE VARCHAR(50) NOT NULL,
  ROLE VARCHAR(255),
...
DROP TABLE IF EXISTS AM_API_EXTERNAL_API_MAPPING;
CREATE TABLE AM_API_EXTERNAL_API_MAPPING (
     API_ID VARCHAR(255) NOT NULL,
...
DROP TABLE IF EXISTS AM_API_LABEL_MAPPING;
CREATE TABLE IF NOT EXISTS AM_API_LABEL_MAPPING (
    API_UUID       VARCHAR(256)     NOT NULL,
...
DROP TABLE IF EXISTS GOV_RULESET;
...
DROP TABLE IF EXISTS GOV_RULESET_CONTENT;
CREATE TABLE IF NOT EXISTS GOV_RULESET_CONTENT (
    RULESET_ID VARCHAR(36) NOT NULL,
...
DROP TABLE IF EXISTS GOV_RULESET_RULE;
...
DROP TABLE IF EXISTS GOV_POLICY_LABEL;
...
DROP TABLE IF EXISTS GOV_POLICY_GOVERNABLE_STATE;
...
DROP TABLE IF EXISTS GOV_POLICY_ACTION;
...
DROP TABLE IF EXISTS GOV_POLICY_RULESET;
...
DROP TABLE IF EXISTS GOV_ARTIFACT;
...
DROP TABLE IF EXISTS GOV_REQUEST;
...
DROP TABLE IF EXISTS GOV_REQUEST_POLICY;
...
DROP TABLE IF EXISTS GOV_POLICY_RUN;
...
DROP TABLE IF EXISTS GOV_RULESET_RUN;
...
DROP TABLE IF EXISTS GOV_RULE_VIOLATION;
...
DROP TABLE IF EXISTS AM_ARTIFACT;
...
DROP TABLE IF EXISTS AM_DEVPORTAL_ORG_CONTENT;
CREATE TABLE AM_DEVPORTAL_ORG_CONTENT (
    ORGANIZATION VARCHAR(100),
...
DROP TABLE IF EXISTS AM_DEVPORTAL_API_CONTENT;
CREATE TABLE AM_DEVPORTAL_API_CONTENT (
    API_UUID VARCHAR(256),
    ORGANIZATION VARCHAR(100),
    DRAFTED_ARTIFACT VARCHAR(45),
    PUBLISHED_ARTIFACT VARCHAR(45),
...
DROP TABLE IF EXISTS AM_DEVPORTAL_API_REFERENCE;
...
DROP TABLE IF EXISTS SP_TRUSTED_APPS;
DROP SEQUENCE IF EXISTS SP_TRUSTED_APPS_SEQ;
CREATE SEQUENCE SP_TRUSTED_APPS_SEQ;
...
DROP TABLE IF EXISTS IDN_NOTIFICATION_TYPE;
DROP SEQUENCE IF EXISTS IDN_NOTIFICATION_TYPE_SEQ;
CREATE SEQUENCE IDN_NOTIFICATION_TYPE_SEQ;
...
DROP TABLE IF EXISTS IDN_NOTIFICATION_ORG_TEMPLATE;
DROP SEQUENCE IF EXISTS IDN_NOTIFICATION_ORG_TEMPLATE_SEQ;
CREATE SEQUENCE IDN_NOTIFICATION_ORG_TEMPLATE_SEQ;
...
DROP TABLE IF EXISTS IDN_NOTIFICATION_APP_TEMPLATE;
DROP SEQUENCE IF EXISTS IDN_NOTIFICATION_APP_TEMPLATE_SEQ;
CREATE SEQUENCE IDN_NOTIFICATION_APP_TEMPLATE_SEQ;
...
DROP TABLE IF EXISTS IDN_ACTION;
...
DROP TABLE IF EXISTS IDN_OAUTH2_TOKEN_CLAIMS;
DROP SEQUENCE IF EXISTS IDN_OAUTH2_TOKEN_CLAIMS_SEQ;
CREATE SEQUENCE IDN_OAUTH2_TOKEN_CLAIMS_SEQ;
...
DROP TABLE IF EXISTS AUTHORIZATION_DETAILS_TYPES;
DROP SEQUENCE IF EXISTS AUTHORIZATION_DETAILS_TYPES_SEQ;
CREATE SEQUENCE AUTHORIZATION_DETAILS_TYPES_SEQ;
...
DROP TABLE IF EXISTS AUTHORIZED_AUTHORIZATION_DETAILS_TYPES;
...
DROP TABLE IF EXISTS IDN_OAUTH2_USER_CONSENTED_AUTHORIZATION_DETAILS;
DROP SEQUENCE IF EXISTS IDN_OAUTH2_USER_CONSENTED_AUTHORIZATION_DETAILS_SEQ;
CREATE SEQUENCE IDN_OAUTH2_USER_CONSENTED_AUTHORIZATION_DETAILS_SEQ;
...
DROP TABLE IF EXISTS IDN_OAUTH2_ACCESS_TOKEN_AUTHORIZATION_DETAILS;
DROP SEQUENCE IF EXISTS IDN_OAUTH2_ACCESS_TOKEN_AUTHORIZATION_DETAILS_SEQ;
CREATE SEQUENCE IDN_OAUTH2_ACCESS_TOKEN_AUTHORIZATION_DETAILS_SEQ;
...
DROP TABLE IF EXISTS IDN_OAUTH2_AUTHZ_CODE_AUTHORIZATION_DETAILS;
DROP SEQUENCE IF EXISTS IDN_OAUTH2_AUTHZ_CODE_AUTHORIZATION_DETAILS_SEQ;
CREATE SEQUENCE IDN_OAUTH2_AUTHZ_CODE_AUTHORIZATION_DETAILS_SEQ;
...
DROP TABLE IF EXISTS IDN_PUSH_DEVICE_STORE;
...
-- ============================================================================
-- 05-shared-db-is-schema.sql
-- ============================================================================

-- Connect to shared_db_is database (for WSO2 Identity Server)
\c shared_db_is
...
CREATE INDEX UM_USER_PERMISSION_UM_PERMISSION_ID_LOWER_UM_USER_NAME_UM_TENANT_ID ON
            UM_USER_PERMISSION(UM_PERMISSION_ID, LOWER(UM_USER_NAME), UM_TENANT_ID);
...
CREATE UNIQUE INDEX UM_ACCOUNT_MAPPING_LOWER_UM_USER_NAME_UM_TENANT_ID_UM_USER_STORE_DOMAIN_UM_ACC_LINK_ID ON UM_ACCOUNT_MAPPING(LOWER(UM_USER_NAME), UM_TENANT_ID, UM_USER_STORE_DOMAIN, UM_ACC_LINK_ID);
...
DROP TABLE IF EXISTS UM_HYBRID_ROLE_AUDIENCE;
DROP SEQUENCE IF EXISTS UM_HYBRID_ROLE_AUDIENCE_PK_SEQ;
CREATE SEQUENCE UM_HYBRID_ROLE_AUDIENCE_PK_SEQ;
CREATE TABLE UM_HYBRID_ROLE_AUDIENCE(
            UM_ID INTEGER DEFAULT NEXTVAL('UM_HYBRID_ROLE_AUDIENCE_PK_SEQ'),
...
DROP TABLE IF EXISTS UM_HYBRID_USER_ROLE_RESTRICTED_EDIT_PERMISSIONS;
DROP SEQUENCE IF EXISTS UM_HYBRID_USER_ROLE_RESTRICTED_EDIT_PERMISSIONS_PK_SEQ;
CREATE SEQUENCE UM_HYBRID_USER_ROLE_RESTRICTED_EDIT_PERMISSIONS_PK_SEQ;
CREATE TABLE UM_HYBRID_USER_ROLE_RESTRICTED_EDIT_PERMISSIONS (
            UM_ID INTEGER DEFAULT NEXTVAL('UM_HYBRID_USER_ROLE_RESTRICTED_EDIT_PERMISSIONS_PK_SEQ'),
            ...
            FOREIGN KEY (UM_HYBRID_USER_ROLE_ID, UM_HYBRID_USER_ROLE_TENANT_ID)
                REFERENCES UM_HYBRID_USER_ROLE(UM_ID, UM_TENANT_ID) ON DELETE CASCADE
);
...
CREATE UNIQUE INDEX UM_SYSTEM_USER_ROLE_LOWER_UM_USER_NAME_UM_ROLE_ID_UM_TENANT_ID ON UM_SYSTEM_USER_ROLE(LOWER(UM_USER_NAME), UM_ROLE_ID, UM_TENANT_ID);
...
DROP TABLE IF EXISTS UM_IDP_GROUP_ROLE;
...
DROP TABLE IF EXISTS UM_SHARED_ROLE;
DROP SEQUENCE IF EXISTS UM_SHARED_ROLE_PK_SEQ;
CREATE SEQUENCE UM_SHARED_ROLE_PK_SEQ;
CREATE TABLE UM_SHARED_ROLE(
            UM_ID INTEGER DEFAULT NEXTVAL('UM_SHARED_ROLE_PK_SEQ'),
...
DROP TABLE IF EXISTS UM_ORG_DISCOVERY;
DROP SEQUENCE IF EXISTS UM_ORG_DISCOVERY_PK_SEQ;
CREATE SEQUENCE UM_ORG_DISCOVERY_PK_SEQ;
CREATE TABLE UM_ORG_DISCOVERY (
            UM_ID INTEGER DEFAULT NEXTVAL('UM_ORG_DISCOVERY_PK_SEQ'),
            UM_ORG_ID VARCHAR(36) NOT NULL,
...
DROP TABLE IF EXISTS UM_ORG_USER_ASSOCIATION;
DROP SEQUENCE IF EXISTS UM_ORG_USER_ASSOCIATION_PK_SEQ;
CREATE SEQUENCE UM_ORG_USER_ASSOCIATION_PK_SEQ;
CREATE TABLE UM_ORG_USER_ASSOCIATION(
    UM_ID INTEGER DEFAULT NEXTVAL('UM_ORG_USER_ASSOCIATION_PK_SEQ'),
    UM_USER_ID VARCHAR(255) NOT NULL,
    UM_ORG_ID VARCHAR(36) NOT NULL,
...
DROP TABLE IF EXISTS UM_RESOURCE_SHARING_POLICY;
DROP SEQUENCE IF EXISTS UM_RESOURCE_SHARING_POLICY_PK_SEQ;
CREATE SEQUENCE UM_RESOURCE_SHARING_POLICY_PK_SEQ;
...
DROP TABLE IF EXISTS UM_SHARED_RESOURCE_ATTRIBUTES;
DROP SEQUENCE IF EXISTS UM_SHARED_RESOURCE_ATTRIBUTES_PK_SEQ;
CREATE SEQUENCE UM_SHARED_RESOURCE_ATTRIBUTES_PK_SEQ;
...
DROP SEQUENCE IF EXISTS KEY_STORE_PK_SEQ;
CREATE SEQUENCE KEY_STORE_PK_SEQ;
...
-- ============================================================================
-- 06-identity-consent-mgmt-schema.sql
-- ============================================================================
